    ...
    function showEvents(){
        ...
        $.ajax({
            ...
            for(var i=0; i<events.length; i++){
                $("#event-details").append("<p>");
                $("#event-details").append(events[i].displayName);
                $("#event-details").append(events[i].start.date);
                $("#event-details").append(events[i].venue.displayName);
